...
- Name: tests/ebr/core/payments/payment-order.spec.js >> business owner - bank account - points - max - now
...
Locator: getByText('Transaction ID #PA32ZH')
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByText('Transaction ID #PA32ZH')
