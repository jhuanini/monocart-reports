...
- Name: tests/ebr/core/payments/payment-order.spec.js >> business owner - bank account - payid - bank - now
...
Locator: getByText('Transaction ID #P2XPNX')
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByText('Transaction ID #P2XPNX')
