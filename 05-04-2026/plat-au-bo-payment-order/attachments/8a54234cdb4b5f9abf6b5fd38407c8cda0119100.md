...
- Name: tests/ebr/core/payments/payment-order.spec.js >> business owner - bank account - payid - credit - Mastercard - now
...
Locator: getByText('Transaction ID #P6F8LM')
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByText('Transaction ID #P6F8LM')
