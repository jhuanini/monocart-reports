...
- Name: tests/ebr/core/payments/payment-order.spec.js >> business owner - bpay - points - bank - partial - now
...
Locator: getByText('Transaction ID #PWAM4J')
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByText('Transaction ID #PWAM4J')
